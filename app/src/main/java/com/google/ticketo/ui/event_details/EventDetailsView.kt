...
class EventDetailsView : Fragment(), CommentAdapter.EventDetailsCallback {
    ...
    private fun setObservers() {
        viewModel.event.observe(this, Observer {
            ...
            event_details_date.text = dateFormat.format(it.eventInfo!!.startDate)
            event_details_time.text = timeFormat.format(it.eventInfo!!.endDate)
            event_details_buy.isSelected = it.eventInfo!!.buy!!
            event_details_sell.isSelected = it.eventInfo!!.sell!!
            event_details_favourite.isSelected = it.eventInfo!!.favourite!!
        })
