...
class CustomProfileView : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.custom_profile_fragment, container, false)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, StringViewModelFactory(context!!, userId)).get(
            CustomProfileViewModel::class.java
        )
    ...
    private fun observers() {
        viewModel.user.observe(viewLifecycleOwner, Observer {
            binding.user = it
            custom_profile_container.isVisible=true
            custom_profile_progress_bar.isVisible=false
        })
